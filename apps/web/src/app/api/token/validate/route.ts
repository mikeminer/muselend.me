...
export async function POST(request: Request) {
    ...
    return NextResponse.json(
      {
        ...
        reason:
          "No verified Base Sepolia Zora Creator Coin validator is configured",
  ...
  try {
    ...
    return NextResponse.json(
      {
        ...
        reason: valid
          ? undefined
          : "Token is neither a registered Zora Creator Coin nor an official MuseLend Base mirror",
        requestId: context.requestId,
      },
      {
        headers: {
    ...
    return apiError(
      ...
      "The on-chain Creator Coin validator could not be read",
    );
  }
}
